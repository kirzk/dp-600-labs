...
The goal of this repository is to document my practical experience with Microsoft Fabric — building lakehouses and data warehouses, loading and querying data with SQL, and preparing data models for reporting in Power BI.

📂 Labs
#	Lab	Key skills
1	Get started with a lakehouse in Microsoft Fabric	Workspaces, lakehouses, uploading files, loading data into Delta tables, querying with the SQL analytics endpoint
2	Analyze data in a data warehouse	Creating a warehouse, creating tables and inserting data with T-SQL, querying tables, creating views, visual queries, defining a data model
...
T-SQL
Delta Lake tables
Power BI (semantic models, visual queries)
...
How to build views and data models that make data ready for reporting
📌 About the Labs
...
Kyrylo Tsyrulik Data Analytics student | Calgary, Alberta LinkedIn · GitHub
